...
def main():
    ...
    project_json = parser.create_project_json(
        owner='HarryLee02', #dont forget to change this to your github username
        ...
        description='An interactive portfolio website, with sections for education, experience, skills, competitions.', #dont forget to change this to your project description
        repo_url='https://github.com/HarryLee02/portfolio', #dont forget to change this to your github repo url
        live_url='https://harrylee.id.vn', #dont forget to change this to your live website url or leave it blank if you dont have one
